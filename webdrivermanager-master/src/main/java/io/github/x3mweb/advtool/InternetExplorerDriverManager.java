...
public class InternetExplorerDriverManager extends WebDriverManager {
    ...
    protected InternetExplorerDriverManager() {
        ...
        exportParameterKey = "advtool.internetExplorerDriverExport";
        driverVersionKey = "advtool.internetExplorerDriverVersion";
        driverUrlKey = "advtool.internetExplorerDriverUrl";
