...
public class PhantomJsDriverManager extends WebDriverManager {
    ...
    protected PhantomJsDriverManager() {
        driverManagerType = DriverManagerType.PHANTOMJS;
        exportParameterKey = "advtool.phantomjsDriverExport";
        driverVersionKey = "advtool.phantomjsDriverVersion";
        driverUrlKey = "advtool.phantomjsDriverUrl";
        driverMirrorUrlKey = "advtool.phantomjsDriverMirrorUrl";
