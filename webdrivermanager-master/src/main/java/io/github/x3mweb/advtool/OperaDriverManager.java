...
public class OperaDriverManager extends WebDriverManager {
    ...
    protected OperaDriverManager() {
        ...
        exportParameterKey = "advtool.operaDriverExport";
        driverVersionKey = "advtool.operaDriverVersion";
        driverUrlKey = "advtool.operaDriverUrl";
        driverMirrorUrlKey = "advtool.operaDriverMirrorUrl";
