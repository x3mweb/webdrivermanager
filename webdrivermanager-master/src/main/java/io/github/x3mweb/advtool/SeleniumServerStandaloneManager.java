...
public class SeleniumServerStandaloneManager extends WebDriverManager {
    ...
    protected SeleniumServerStandaloneManager() {
        driverManagerType = DriverManagerType.SELENIUM_SERVER_STANDALONE;
        driverVersionKey = "advtool.seleniumServerStandaloneVersion";
        driverUrlKey = "advtool.seleniumServerStandaloneUrl";
