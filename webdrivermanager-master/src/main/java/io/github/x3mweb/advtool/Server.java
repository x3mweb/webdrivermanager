...
import static io.github.x3mweb.advtool.WebDriverManager.chromedriver;
import static io.github.x3mweb.advtool.WebDriverManager.edgedriver;
import static io.github.x3mweb.advtool.WebDriverManager.firefoxdriver;
import static io.github.x3mweb.advtool.WebDriverManager.iedriver;
import static io.github.x3mweb.advtool.WebDriverManager.operadriver;
import static io.github.x3mweb.advtool.WebDriverManager.phantomjs;
import static io.github.x3mweb.advtool.WebDriverManager.seleniumServerStandalone;
    ...
    private synchronized void resolveDriver(Context ctx,
        ...
        if (!queryParamMap.isEmpty()) {
            ...
            for (Entry<String, List<String>> entry : queryParamMap.entrySet()) {
                String configKey = "advtool." + entry.getKey();
        ...
        for (String key : queryParamMap.keySet()) {
            System.clearProperty("advtool." + key);
        }
    }
